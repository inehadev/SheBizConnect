...
=======
                const response = await axios.get("https://shebizconnect-server.vercel.app/getCategory");
>>>>>>> b742507c4e65e3e0219653634627be54ca70c2cb
       ...
       <Marquee play speed={100} pauseOnHover={true}>
             ...
             <div className="mt-10 flex  flex-wrap justify-center gap-14">
              ...
              { categories.map((item)=>(
                   ...
                   <p className="text-xl mt-2 text-gray-700  opaciy-80 font-poppins  text-center font-weigh-5 " > {item.CategoryType}</p>
                   </div>
                 </div>
                  </div>
          ))}
